...
public class SplitString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(splitString.solution("banana"));
    }
    ...
    public int solution(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            if (xcnt != 0 && xcnt == otherCnt) {
                System.out.println("분리");
                targetChar = s.charAt(i);
                xcnt = 1;
                otherCnt = 0;
                answer++;
                System.out.println("갈아끼우기 : " + s.charAt(i));
            }else{
                System.out.println("읽는중 : " + s.charAt(i));
