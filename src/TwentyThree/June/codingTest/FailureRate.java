...
이 문제를 어떻게 할까 고민 한 그녀는 동적으로 게임 시간을 늘려서
난이도를 조절하기로 했다. 역시 슈퍼 개발자라 대부분의 로직은 쉽게 구현했지만,
...
[4,1,2,3]
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(failureRate.solution(5, new int[]{2, 1, 2, 6, 2, 4, 3, 3})));
    }
